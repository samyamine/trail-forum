...
import {formatTime, getAuthor, getComments, getTopic} from "@/lib/topic/utils";
...
export default function Topic({ lang, id }: { lang: string, id: string }) {
    ...
    const toggleSave = async () => {
        if (isUndefined(userData)) {
            ...
            await updateDoc(authorRef, {
                saved: arrayUnion(doc(db, "topics", String(id))),
            });
            ...
            {topicData !== null ? (
                <div className={`w-full md:w-2/3 lg:w-1/2 p-5`}>
                    ...
                    <div className={`mb-4 flex gap-5`}>
                        ...
                        <Share dictionary={dictionary} onClickCallback={() => showSharePopup(id)} />
                    </div>
